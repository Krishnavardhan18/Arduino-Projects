...
#define AIO_USERNAME    "Krishna_vardhan"
#define AIO_KEY         "aio_muQr59hdsEeNYkUk13jgkjhRpqvN"
...
Adafruit_MQTT_Subscribe message = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME "/feeds/text");
...
void setup()
{
  ...
  WiFi.mode(WIFI_STA);
  WiFiMulti.addAP("No Access", "chathurajupalli");
